...
bsub << EOF
#!/bin/bash
#BSUB -J deepsnooze_lora_deep_r3
#BSUB -q gpua40
#BSUB -gpu "num=1:mode=exclusive_process"
#BSUB -n 8
#BSUB -R "rusage[mem=8GB]"
#BSUB -W 24:00
#BSUB -o lora_deep_r3.out
#BSUB -e lora_deep_r3.err

source ~/.bashrc
cd ~/Desktop/Deepsnooze
uv run python -m deepsnooze.train model=cnn_deep training=lora training.rank=3 wandb.group=lora "wandb.notes='Standard LoRA rank=3 on frozen cnn_deep base.'"
EOF

bsub << EOF
#!/bin/bash
#BSUB -J deepsnooze_bayesian_lora_deep_r3
#BSUB -q gpua40
#BSUB -gpu "num=1:mode=exclusive_process"
#BSUB -n 8
#BSUB -R "rusage[mem=8GB]"
#BSUB -W 24:00
#BSUB -o bayesian_lora_deep_r3.out
#BSUB -e bayesian_lora_deep_r3.err

source ~/.bashrc
cd ~/Desktop/Deepsnooze
uv run python -m deepsnooze.train model=cnn_deep training=bayesian_lora training.rank=3 wandb.group=lora "wandb.notes='Bayesian LoRA rank=3 on frozen cnn_deep base. Uncertainty-aware FC layers via Pyro SVI.'"
EOF

bsub << EOF
#!/bin/bash
#BSUB -J deepsnooze_lora_deep_r8
#BSUB -q gpua40
#BSUB -gpu "num=1:mode=exclusive_process"
#BSUB -n 8
#BSUB -R "rusage[mem=8GB]"
#BSUB -W 24:00
#BSUB -o lora_deep_r8.out
#BSUB -e lora_deep_r8.err

source ~/.bashrc
cd ~/Desktop/Deepsnooze
uv run python -m deepsnooze.train model=cnn_deep training=lora training.rank=8 wandb.group=lora "wandb.notes='Standard LoRA rank=8 on frozen cnn_deep base.'"
EOF

bsub << EOF
#!/bin/bash
#BSUB -J deepsnooze_bayesian_lora_deep_r8
#BSUB -q gpua40
#BSUB -gpu "num=1:mode=exclusive_process"
#BSUB -n 8
#BSUB -R "rusage[mem=8GB]"
#BSUB -W 24:00
#BSUB -o bayesian_lora_deep_r8.out
#BSUB -e bayesian_lora_deep_r8.err

source ~/.bashrc
cd ~/Desktop/Deepsnooze
uv run python -m deepsnooze.train model=cnn_deep training=bayesian_lora training.rank=8 wandb.group=lora "wandb.notes='Bayesian LoRA rank=8 on frozen cnn_deep base. Uncertainty-aware FC layers via Pyro SVI.'"
EOF

echo "Submitted 8 LoRA jobs (standard + bayesian, ranks 1 3 5 8)."
